...
import { getUsersByIdService, getUsersService, postUsersLoginService, postUsersRegisterService } from "../services/usersService"
...
const postUsersRegister= async(req:Request,res:Response)=>{
    ...
    const newUser:User=await postUsersRegisterService({name,email,birthdate,nDni,password,file})
