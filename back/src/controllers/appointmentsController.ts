...
import { getAppointmentByIdService, getAppointmentService, postAppointmentsScheduleService, putAppointmentsCancelService } from "../services/AppointmentService"
...
const postAppointmentsSchedule=async(req:Request,res:Response)=>{
    ...
    const newAppointment:Appointment=await postAppointmentsScheduleService(postAppointmentsScheduleData)
...
const putAppointmentsCancel=async(req:Request,res:Response)=>{
    ...
    const appointmentCancelled:Appointment=await putAppointmentsCancelService(idCancel)
